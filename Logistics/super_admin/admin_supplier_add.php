...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Create New Supplier
        <small>fill-up form with suppliers informations</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header ">
              ...
              <h3 class="box-title">New Supplier Form </h3>
              ...
              <table class="table table-hover">
                <tr>
                  ...
                  <td>
                    ...
                    <input type="text" name="company_code" class="form-control input-sm" placeholder="">
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2">
                    ...
                    <input type="text" name="supplier_address" class="form-control input-sm" placeholder="Enter">
                  </td>
                  <td>
                    <label for="exampleInputEmail1">Postal Code</label>
                    <input type="number" name="supplier_postal_code" class="form-control input-sm" placeholder="Enter">
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    ...
                    <input type="text" name="contact_name" class="form-control input-sm" placeholder="Enter">
                  </td>
                  <td>
                    <label for="exampleInputEmail1">Mobile Number</label>
                    <input type="number" name="supplier_phone_number" class="form-control input-sm" placeholder="Enter">
                  </td>
                  <td>
                    <label for="exampleInputEmail1">Tel. Number</label>
                    <input type="number" name="supplier_tel_number" class="form-control input-sm" placeholder="Enter">
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    ...
                    <input type="email" name="supplier_email_address" class="form-control input-sm" placeholder="Enter">
                  </td>
                  <td>
                    <label for="exampleInputEmail1">Fax</label>
                    <input type="text" name="supplier_fax" class="form-control input-sm" placeholder="Enter">
                  </td>
                  <td>
                    <label for="exampleInputEmail1">Others</label>
                    <input type="text" name="supplier_extra" class="form-control input-sm" placeholder="Enter">
                  </td>
                </tr>
                    <footer>
                  <tr>
                    ...
                    <th>
                      <div class="col-md-12">
                      <button type="submit" name="supplier_add_submit"  class="btn btn-block btn-primary">Create Supplier</button></div>
                    </form>
                    </th>
                  </tr>
                </footer>
