              ...
              <table class="table table-hover">
                <tr>
                  <td colspan="2"> 
                    ...
                    <input type="text" class="form-control input-sm" id="exampleInputEmail1" placeholder="Eto yung makikita nila sa select supplier pag nag gawa ng PO">
                  </td>
                  <td> 
                    <label for="exampleInputEmail1">Company Code</label>
                    <input type="text" class="form-control input-sm" id="exampleInputEmail1" placeholder="">
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2"> 
                    ...
                    <input type="text" class="form-control input-sm" id="exampleInputEmail1" placeholder="Enter">
                  </td>
                  <td> 
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <th>
                      <div class="col-md-12">
                      <button type="button" class="btn btn-block btn-primary">Create Supplier</button></div>
                    </th>
                  </tr>
                </footer>
              </table>
