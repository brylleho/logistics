    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="admin_users_add.php"><i class="fa fa-user-plus"></i> <span>Manage Users</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  <tr>
                    ...
                    <form method="post" action="admin_po_list.php" enctype="multipart/form-data">
  ...
  <!--------------------------
        ...
        <table class="table table-hover">
          ...
          <tr>
            ...
            <th id="verified_by" name="verified_by"></th>
            <th id="approved_by" name="approved_by"></th>
            <th>__________</th>
            <th>__________</th>
          </tr>
